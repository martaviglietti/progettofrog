...
typedef struct{
	...
	int x;
	int y;
	int info;  //variabile utilizzata per contenere informazioni diverse durante l'esecuzione (abbiamo puntato a mantenere i messaggi i più compatti possibili per una maggiore efficienza)
}Temp;
